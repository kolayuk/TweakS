 ...
 * @return initialized instance of CPluginsList
 */
CPluginsList* CPluginsList::NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CPluginsList* self = CPluginsList::NewLC( 
			aRect, 
			aParent, 
			aCommandObserver );
 ...
 * @param aParent owning parent, or NULL
 * @param aCommandObserver command observer
 * @return new instance of CPluginsList
 */
CPluginsList* CPluginsList::NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CPluginsList* self = new ( ELeave ) CPluginsList();
...
* @return count
*/
TInt CPluginsList::CountComponentControls() const
	{
...
*/
CCoeControl* CPluginsList::ComponentControl( TInt aIndex ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
	switch ( aIndex )
		{
 ...
 */
void CPluginsList::LayoutControls()
	{
 ...
 *	Handle key events.
 */				
TKeyResponse CPluginsList::OfferKeyEventL( 
 ...
 */				
void CPluginsList::InitializeControlsL()
	{
	iListBox = new ( ELeave ) CAknDoubleStyleListBox;
	iListBox->SetContainerWindowL( *this );
		{
		TResourceReader reader;
		iEikonEnv->CreateResourceReaderLC( reader, R_PLUGINS_LIST_LIST_BOX );
	...
	AddListBoxEventHandlerL( 
			...
			&CPluginsList::HandleListBoxEnterKeyPressedL );
	AddListBoxEventHandlerL( 
			iListBox, 
			EEventItemSingleClicked, 
			&CPluginsList::HandleListBoxItemClickedL );
 ...
 */
void CPluginsList::HandleResourceChange( TInt aType )
	{
	CCoeControl::HandleResourceChange( aType );
	SetRect( iAvkonViewAppUi->View( TUid::Uid( EPluginsListViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 */				
void CPluginsList::Draw( const TRect& aRect ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
 ...
 */
void CPluginsList::AddListBoxItemL( 
 ...
 */
RArray< TInt >* CPluginsList::GetSelectedListBoxItemsLC( CEikTextListBox* aListBox )
	{
 ...
 */
void CPluginsList::DeleteSelectedListBoxItemsL( CEikTextListBox* aListBox )
	{
	CAknFilteredTextListBoxModel* model = 
		static_cast< CAknFilteredTextListBoxModel *> ( aListBox->Model() );
	if ( model->NumberOfItems() == 0 )
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CPluginsList::ListBox()
	{
	return iListBox;
	}
 ...
 */
void CPluginsList::CreateListBoxItemL( TDes& aBuffer, 
 ...
 *	
 */
void CPluginsList::AddListBoxResourceArrayItemL( TInt aResourceId )
	{
 ...
 */
void CPluginsList::SetupListBoxIconsL()
	{
 ...
 */
TBool CPluginsList::HandleMarkableListCommandL( TInt aCommand )
	{
	return EFalse;
	}
 ...
 */
void CPluginsList::HandleListBoxEventL( 
 ...
 */
void CPluginsList::AddListBoxEventHandlerL( 
		CEikListBox* aListBox,
 ...
 */
void CPluginsList::HandleListBoxItemClickedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	if (iListBox->Model()->NumberOfItems()!=0){((CPluginsListView*)iCommandObserver)->HandleLBSelect();}		
	}

/**
 *	Handle the enterKeyPressed event
 */
void CPluginsList::HandleListBoxEnterKeyPressedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	if (iListBox->Model()->NumberOfItems()!=0){((CPluginsListView*)iCommandObserver)->HandleLBSelect();}
