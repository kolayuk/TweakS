 ...
 * @return initialized instance of CSettingList
 */
...
* @return count
*/
TInt CSettingList::CountComponentControls() const
	{
...
*/
CCoeControl* CSettingList::ComponentControl( TInt aIndex ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
	switch ( aIndex )
		{
 ...
 */
void CSettingList::LayoutControls()
	{
 ...
 *	Handle key events.
 */				
TKeyResponse CSettingList::OfferKeyEventL( 
 ...
 */
void CSettingList::HandleResourceChange( TInt aType )
	{
	CCoeControl::HandleResourceChange( aType );
	SetRect( iAvkonViewAppUi->View( TUid::Uid( ESettingListViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 */				
void CSettingList::Draw( const TRect& aRect ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
 ...
 *	Get the listbox.
 */
CAknSettingStyleListBox* CSettingList::ListBox()
	{
	return iListBox;
	}
 ...
 *	
 */
void CSettingList::AddListBoxResourceArrayItemL( TInt aResourceId )
	{
 ...
 */
void CSettingList::SetupListBoxIconsL()
	{
 ...
 */
TBool CSettingList::HandleMarkableListCommandL( TInt aCommand )
	{
	return EFalse;
	}
 ...
 */
void CSettingList::HandleListBoxEventL( 
 ...
 */
void CSettingList::AddListBoxEventHandlerL( 
		CEikListBox* aListBox,
 ...
 */
void CSettingList::HandleListBoxItemClickedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	((CSettingListView*)iCommandObserver)->HandleLBSelect();		
	}

/**
 *	Handle the enterKeyPressed event
 */
void CSettingList::HandleListBoxEnterKeyPressedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	((CSettingListView*)iCommandObserver)->HandleLBSelect();	
