 ...
 * @return initialized instance of CAddingPlugin
 */
CAddingPlugin* CAddingPlugin::NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CAddingPlugin* self = CAddingPlugin::NewLC( 
			aRect, 
			aParent, 
			aCommandObserver );
 ...
 * @param aParent owning parent, or NULL
 * @param aCommandObserver command observer
 * @return new instance of CAddingPlugin
 */
CAddingPlugin* CAddingPlugin::NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CAddingPlugin* self = new ( ELeave ) CAddingPlugin();
...
* @return count
*/
TInt CAddingPlugin::CountComponentControls() const
	{
...
*/
CCoeControl* CAddingPlugin::ComponentControl( TInt aIndex ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
	switch ( aIndex )
		{
 ...
 *  any screen size.
 */				
void CAddingPlugin::SizeChanged()
	{
 ...
 */
void CAddingPlugin::LayoutControls()
	{
 ...
 *	Handle key events.
 */				
TKeyResponse CAddingPlugin::OfferKeyEventL( 
	...
	if (aKeyEvent.iCode==EKeyBackspace)
		{((CAddingPluginView*)iCommandObserver)->Remove(0);}
	if ((aKeyEvent.iCode==EKeyEnter||aKeyEvent.iCode==EKeyOK)&&ListBox()->Model()->NumberOfItems()==0)
		{((CAddingPluginView*)iCommandObserver)->MenuBar()->TryDisplayMenuBarL();}
 ...
 */				
void CAddingPlugin::InitializeControlsL()
	{
	iListBox = new ( ELeave ) CAknDoubleStyleListBox;
	iListBox->SetContainerWindowL( *this );
		{
		TResourceReader reader;
		iEikonEnv->CreateResourceReaderLC( reader, R_ADDING_PLUGIN_LIST_BOX );
	...
	AddListBoxEventHandlerL( 
			...
			&CAddingPlugin::HandleListBoxEnterKeyPressedL );
	AddListBoxEventHandlerL( 
			iListBox, 
			EEventItemSingleClicked, 
			&CAddingPlugin::HandleListBoxItemClickedL );
 ...
 */
void CAddingPlugin::HandleResourceChange( TInt aType )
	{
	CCoeControl::HandleResourceChange( aType );
	SetRect( iAvkonViewAppUi->View( TUid::Uid( EAddingPluginViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 */				
void CAddingPlugin::Draw( const TRect& aRect ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
 ...
 */
void CAddingPlugin::AddListBoxItemL( 
 ...
 */
RArray< TInt >* CAddingPlugin::GetSelectedListBoxItemsLC( CEikTextListBox* aListBox )
	{
 ...
 */
void CAddingPlugin::DeleteSelectedListBoxItemsL( CEikTextListBox* aListBox )
	{
	CAknFilteredTextListBoxModel* model = 
		static_cast< CAknFilteredTextListBoxModel *> ( aListBox->Model() );
	if ( model->NumberOfItems() == 0 )
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CAddingPlugin::ListBox()
	{
	return iListBox;
	}
 ...
 */
void CAddingPlugin::CreateListBoxItemL( TDes& aBuffer, 
 ...
 *	
 */
void CAddingPlugin::AddListBoxResourceArrayItemL( TInt aResourceId )
	{
 ...
 */
void CAddingPlugin::SetupListBoxIconsL()
	{
 ...
 */
TBool CAddingPlugin::HandleMarkableListCommandL( TInt aCommand )
	{
	return EFalse;
	}
 ...
 */
void CAddingPlugin::HandleListBoxEventL( 
 ...
 */
void CAddingPlugin::AddListBoxEventHandlerL( 
		CEikListBox* aListBox,
 ...
 */
void CAddingPlugin::HandleListBoxItemClickedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
 ...
 */
void CAddingPlugin::HandleListBoxEnterKeyPressedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	((CAddingPluginView*)iCommandObserver)->HandleLBSelect();		
	}
