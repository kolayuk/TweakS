...
========================================================================
*/
#ifndef ADDINGPLUGIN_H
#define ADDINGPLUGIN_H
...
/**
 * Container class for AddingPlugin
 * 
 * @class	CAddingPlugin AddingPlugin.h
 */
class CAddingPlugin : public CCoeControl
	,MEikListBoxObserver	{
public:
	// constructors and destructor
	CAddingPlugin();
	static CAddingPlugin* NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	static CAddingPlugin* NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	void ConstructL( 
...
private: 
	typedef void ( CAddingPlugin::*ListBoxEventHandler )( 
			CEikListBox* aListBox, 
