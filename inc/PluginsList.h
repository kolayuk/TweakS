...
/**
 * Container class for PluginsList
 * 
 * @class	CPluginsList PluginsList.h
 */
class CPluginsList : public CCoeControl
	,MEikListBoxObserver	{
public:
	// constructors and destructor
	CPluginsList();
	static CPluginsList* NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	static CPluginsList* NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	void ConstructL( 
		...
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	virtual ~CPluginsList();
	void CreateElement(TDes&,TDes&);
	void Update();
public:
...
private: 
	typedef void ( CPluginsList::*ListBoxEventHandler )( 
			CEikListBox* aListBox, 
