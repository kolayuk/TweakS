...
/**
 * Container class for PluginsManager
 * 
 * @class	CPluginsManager PluginsManager.h
 */
class CPluginsManager : public CCoeControl
	,MEikListBoxObserver	{
public:
	// constructors and destructor
	CPluginsManager();
	static CPluginsManager* NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	static CPluginsManager* NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	void ConstructL( 
...
private: 
	typedef void ( CPluginsManager::*ListBoxEventHandler )( 
			CEikListBox* aListBox, 
